...
public class HubParkour extends JavaPlugin {
    ...
    private boolean loadItems() {
        ...
        if (ConfigUtil.getInt("Settings.Parkour-Items.Cancel.Slot", 6) != -1) {
            ItemStack item = ItemUtil.ci(cancel, ConfigUtil.getString("Settings.Parkour-Items.Cancel.Name", "&cCancel"), 1, "", (short) ConfigUtil.getInt("Settings.Parkour-Items.Cancel.Item-Data", 0), ConfigUtil.getInt("Settings.Parkour-Items.Cancel.Custom-Model-Data", -1), "cancel");
            CacheManager.setItem(2, item);
        }

        if (ConfigUtil.getInt("Settings.Parkour-Items.Reset.Slot", 5) != -1) {
            ItemStack item = ItemUtil.ci(reset, ConfigUtil.getString("Settings.Parkour-Items.Reset.Name", "&cReset"), 1, "", (short) ConfigUtil.getInt("Settings.Parkour-Items.Reset.Item-Data", 0), ConfigUtil.getInt("Settings.Parkour-Items.Reset.Custom-Model-Data", -1), "reset");
            CacheManager.setItem(0, item);
        }

        if (ConfigUtil.getInt("Settings.Parkour-Items.Checkpoint.Slot", 4) != -1) {
            ItemStack item = ItemUtil.ci(checkpoint, ConfigUtil.getString("Settings.Parkour-Items.Checkpoint.Name", "&aTeleport to Last Checkpoint"), 1, "", (short) ConfigUtil.getInt("Settings.Parkour-Items.Checkpoint.Item-Data", 0), ConfigUtil.getInt("Settings.Parkour-Items.Checkpoint.Custom-Model-Data", -1), "checkpoint");
            CacheManager.setItem(1, item);
        }

        if (ConfigUtil.getInt("Settings.Parkour-Items.Hide.Slot", 8) != -1) {
            ItemStack item = ItemUtil.ci(hidden, ConfigUtil.getString("Settings.Parkour-Items.Hide.Hidden.Name", "&cShow all players"), 1, "", (short) ConfigUtil.getInt("Settings.Parkour-Items.Hide.Hidden.Item-Data", 0), ConfigUtil.getInt("Settings.Parkour-Items.Hide.Hidden.Custom-Model-Data", -1), "show-players");
            CacheManager.setItem(4, item);
            item = ItemUtil.ci(shown, ConfigUtil.getString("Settings.Parkour-Items.Hide.Shown.Name", "&aHide all players"), 1, "", (short) ConfigUtil.getInt("Settings.Parkour-Items.Hide.Shown.Item-Data", 0), ConfigUtil.getInt("Settings.Parkour-Items.Hide.Shown.Custom-Model-Data", -1), "hide-players");
